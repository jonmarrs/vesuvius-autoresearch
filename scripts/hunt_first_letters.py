...
def main():
    ...
    parser.add_argument("--scroll", type=int, default=2, help="Scroll to hunt on (default: 2)")
    parser.add_argument("--duration", type=int, default=48, help="Duration in hours to hunt")
    parser.add_argument("--batch_size", type=int, default=16, help="Batch size for predictions")
    args = parser.parse_args()

    print(f"--- Starting First Letters Hunt ---")
