...
# Arm 1 keeps the tag of the fit that IS arm 1 -- anchor10cov_pilot, seed 1 on
# the coverage-matched dataset (preregistration amendment 2). Naming it
# "anchor10cov_s1" would mean passing a file whose path says "pilot" under a tag
# that does not, with nothing checking the two agreed. The honest tag is
# self-verifying, and the 3-arm count still refuses both being passed.
ABLATED_ARMS = ("anchor10cov_pilot", "anchor10cov_s2", "anchor10cov_s3")
