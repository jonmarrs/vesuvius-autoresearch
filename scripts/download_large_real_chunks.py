...
# PHerc0139 (Scroll 1) for Training
print("Downloading ~1GB of PHerc0139 (Scroll 1) training data...")
download_chunks('PHerc0139/volumes/20260102150214-2.399um-0.2m-78keV-masked.zarr/0/', 'local_data/RealScroll_1_Large/0/', target_gb=1.0)

# PHerc1667 (Scroll 4) for Validation
print("\nDownloading ~1GB of PHerc1667 (Scroll 4) validation data...")
download_chunks('samples/PHerc1667/volumes/20231117161658-7.910um-53keV-masked.zarr/0/', 'local_data/RealScroll_4_Large/0/', target_gb=1.0)
