...
def generate():
    ...
    with open('local_data_manifest.md', 'w') as f:
        ...
        f.write("This document lists the offline datasets currently built and stored in `local_data/`. ")
        f.write("These datasets are completely excluded from git due to their massive size (~63GB total). ")
        f.write("To regenerate these datasets locally, you must run the download scripts provided in this repository.\n\n")
        ...
        f.write("These represent 1GB slices taken at 10% depth intervals through the full scroll volumes to ensure diverse topological representation.\n\n")
