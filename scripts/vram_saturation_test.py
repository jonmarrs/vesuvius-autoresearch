...
def check_memory(patch_size, batch_size, num_layers=16, base_feat=64):
    ...
    print(f"Testing: patch_size={patch_size}, batch_size={batch_size}, num_layers={num_layers}")
    ...
    try:
        ...
        # Create dummy data
        x = torch.randn(batch_size, 1, num_layers, patch_size, patch_size, device=device)
...
def main():
    ...
    print("Note: The competition strictly limits window sizes to 64x64 for submissions.")
