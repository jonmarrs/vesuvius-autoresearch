...
# PHerc0172 (Scroll 5) for Validation
print("\nDownloading ~1GB of PHerc0172 (Scroll 5) validation data...")
download_chunks('PHerc0172/volumes/20241024131838-7.910um-53keV-masked.zarr/0/', 'local_data/RealScroll_5_Large/0/', target_gb=1.0)
