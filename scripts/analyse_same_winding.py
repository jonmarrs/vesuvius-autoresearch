"""Same-winding ablation: do those constraints improve reading, or only geometry?

**Written before the first ABLATED fit was started**, implementing
`docs/preregistration/2026-09-06_same_winding_ablation.md` and nothing else.
...
ABLATED_ARMS = ("nosame_s1", "nosame_s2", "nosame_s3")
...
def main() -> int:
    ...
    print(f"SAME-WINDING ABLATION, alpha = {ALPHA}. 5,413 constraints removed.")
