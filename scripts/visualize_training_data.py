...
def visualize_training_samples(uri, label_path, mask_path=None, num_samples=5, patch_size=128, num_layers=12):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Visualize samples from a labeled Vesuvius dataset")
    parser.add_argument("--uri", type=str, default='local_data/PHercParis2Fr47/surface_volume/', help="Path to volume data")
    parser.add_argument("--labels", type=str, default='local_data/PHercParis2Fr47/inklabels.png', help="Path to labels PNG")
    parser.add_argument("--mask", type=str, default='local_data/PHercParis2Fr47/mask.png', help="Path to mask PNG")
