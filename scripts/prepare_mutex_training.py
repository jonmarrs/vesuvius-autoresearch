...
def main():
    ...
    parser.add_argument("--curated_zarr", type=str, required=True, help="Path to curated Gold Standard Zarr")
    parser.add_argument("--output_dir", type=str, default="local_data/curated_fragments")
    ...
    cmd = [
        ...
        temp_tiff_dir,
        affinity_dir,
        "--pattern", f"{frag_name}_labels.tif",
        "--foreground-threshold", "0.5", # Curation produced clean binary/instance masks
        "--overwrite"
    ]
