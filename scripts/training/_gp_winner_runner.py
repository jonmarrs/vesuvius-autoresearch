...
GP_WINNER_ROOT = Path(
    "/home/jon/openclaw-workspace/Neo-VM/projects/vesuvius-autoresearch/villa/segmentation/models/multi-task-3d-unet"
)
...
def main():
    parser = argparse.ArgumentParser(
        description="Run villa GP-2023 TimeSformerInk recipe."
    )
