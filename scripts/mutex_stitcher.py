...
VILLA_THAUMATO_PATH = os.path.join(
    PROJECT_ROOT, "villa/thaumato-anakalyptor/ThaumatoAnakalyptor"
)
...
from vesuvius.models.training.trainers.mutex_affinity_trainer import (
    MutexAffinityTrainer,
)
