...
> (`total_fg_pixels`) with a geometry cross-check (`satisfied_area`), and we have **two pre-registered
> cases where those move independently in opposite directions** — a config change that improved
