#!/usr/bin/env bash
# ARM 2 of 3 for the anchor ablation, registered in
# docs/preregistration/2026-09-12_anchor_ablation.md.
#
# 10 z-coverage-matched anchors (1 @ z14268, 8 @ z15694, 1 @ z15976) against the
# 50 in-ROI anchors the curbase_s* baselines used. Seed 2, matching curbase_s2.
#
...
export FIT_SPIRAL_RUN_TAG=anchor10cov_s2
