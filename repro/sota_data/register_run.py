...
TARGETS = {
    "orig": {
        ...
        "extra_disclosure": (
            ...
            "is a separate matter: either the cross-scan floor varies more by segment than "
            "the held-out measurement suggested, or this target carries an additional defect "
            "that has not been isolated. Its excess over the mesh-cell-rounding prediction "
            "is a suspiciously uniform ~(-30, -31) px on both axes, which is a lead, not a "
            "diagnosis — a same-looking numeric coincidence was chased once already in this "
            "investigation and turned out to be nothing. **The threshold was deliberately "
            "NOT raised to give this row headroom.** Placement uncertainty here is "
            "**~0.45 mm**, vs 0.31 mm on the held-out target; "
