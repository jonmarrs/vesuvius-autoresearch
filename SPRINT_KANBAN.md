...
- **[Sprint 031] Vesuvius-C Python Bindings**: (DONE in `vesuvius_c_wrapper/`) Built high-speed `ctypes` bindings for `villa/vesuvius-c` to load local OME-Zarr blocks into NumPy arrays via shared pointers. Submitted for the April 30th Progress Prize.
...
- **[Sprint 011] Colophon "First Title" Search**: (DONE) Targeted inner-core scanning of Scrolls 1, 2, and 3 (`div_100`). *Best run after Sprint 020 (UA-MT) or Sprint 018 (fallback) has generated pseudo-labels for the colophon region.*
