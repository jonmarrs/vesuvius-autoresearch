...
| foundation | `unwired` | `medium` | Dataset management and fiber-label assets. | `scripts/generate_fiber_labels.py` missing | Use fiber assets to expand supervision for hard geometry candidates. |
